...
classifier=ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/XxirhOKeS/model.json', modelLoaded);
...
function check(){
    img=document.getElementById('captuere_image');
